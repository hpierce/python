...
webpage = '/var/www/html/pinesol60/r/testing/1/html/' + city + '.html'
#----------------------------------------------------------------------------
#
#	Start time
#
...
web.write("<h1>" + bcity + " Hourly Forecast</h1>\n<table border=1 cellpadding=4>\n")
#----------------------------------------------------------------------------
#
#	Get data
#
...
for line in weather:
	...
	if 'heat index' in line:
		...
		for i in range(1,168):
			...
			temp = adata[j].replace('</value','')
			heats.append(temp)
	if 'probability-of-precipitation' in line:
		adata = []
		adata = line.split(">")
		for i in range(1,168):
			j = 2 * i
...
web.write("<tr><td>Chance of Precipitation</td><td>" + precips[s] + "</td><td>" + precips[s + 1] + "</td><td>" + precips[s + 2] + "</td><td>" + precips[s + 3] + "</td><td>" + precips[s + 4] + "</td><td>" + precips[s + 5] + "</td><td>" + precips[s + 6] + "</td></tr>")
web.write("<tr><td>Heat Index</td><td>" + heats[s] + "</td><td>" + heats[s + 1] + "</td><td>" + heats[s + 2] + "</td><td>" + heats[s + 3] + "</td><td>" + heats[s + 4] + "</td><td>" + heats[s + 5] + "</td><td>" + heats[s + 6] + "</td></tr>")
get_peak(temps)
#----------------------------------------------------------------------------
#
#	Print data - day 2
